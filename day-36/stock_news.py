...
from secrets import TWILIO_ACCOUNT_SID, \
    TWILIO_PHONE_NUMBER, \
    TWILIO_AUTH_TOKEN, \
    NEWS_API, \
    ALPHA_ADVANTAGE_API, \
    FRIEND, MY_PHONE_NUMBER

VIRTUAL_TWILIO_NUMBER = TWILIO_PHONE_NUMBER
VERIFIED_NUMBER = MY_PHONE_NUMBER
...
STOCK_API_KEY = ALPHA_ADVANTAGE_API
